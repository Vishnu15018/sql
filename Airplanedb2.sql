...
---TABLE FOR FLIGHT
--create table FLIGHT(Flight_Number varchar(255) primary key,Airline varchar(255),Week_Days number);
--insert into FLIGHT
...
--CREATE TABLE FLIGHT_LEG(Flight_Number varchar(255), foreign key(Flight_Number) references FLIGHT(Flight_Number),Leg_No number,PRIMARY KEY(Leg_No,Flight_Number),Scheduled_Dep_Time varchar(255),Scheduled_Arr_Time varchar(255),Depature_Airport_Code varchar(255),Arrival_Airport_Code varchar(255),foreign key(Depature_Airport_Code) references AIRPORT(Airport_Code),foreign key(Arrival_Airport_Code) references AIRPORT(Airport_Code));
...
-------TABLE FOR FARE
--create table FARE(Flight_Number varchar(255), foreign key(Flight_Number) references FLIGHT(Flight_Number),Fare_Code varchar(255),PRIMARY KEY(Flight_Number,Fare_Code),Restrictions varchar(255),Amount number);
...
--create table AIRPLANE_TYPE(Airplane_Type_Name varchar(255) primary key,Max_Seats number,Company varchar(255));
--insert into Airplane_type values('JET',50,'SAFRAN');
...
--TABLE FOR AIRPLANE
--CREATE TABLE AIRPLANE(Airplane_Id varchar(255) primary key,Total_No_Of_Seats number,Airplane_Type_Name varchar(255),foreign key(Airplane_Type_Name) references AIRPLANE_TYPE(Airplane_Type_Name));
--INSERT INTO AIRPLANE VALUES('AB1290',50,'JET');
...
--create table LEG_INSTANCE(Flight_Number varchar(255), Leg_No number,foreign key(Flight_Number,Leg_no) references FLIGHT_LEG(Flight_Number,Leg_No),Date_Leg date,PRIMARY KEY(Leg_No,Flight_Number,Date_Leg),No_Of_Avail_Seats number,Depature_Airport_Code varchar(255),Arrival_Airport_Code varchar(255),foreign key(Depature_Airport_Code) references AIRPORT(Airport_Code),foreign key(Arrival_Airport_Code) references AIRPORT(Airport_Code),Dep_Time varchar(255),Arr_Time varchar(255),Airplane_Id varchar(255),foreign key(Airplane_Id) references AIRPLANE(Airplane_Id));
--INSERT INTO LEG_INSTANCE VALUES('LN3211',1,'01-01-2014',250,'H1','Y2','4:00PM','6:00PM','AB1290');
--INSERT INTO LEG_INSTANCE VALUES('GT4638',2,'01-01-2014',150,'C1','V2','4:55PM','6:34PM','AB123');
--INSERT INTO LEG_INSTANCE VALUES('KV3323',3,'01-12-2021',250,'M1','P1','5:00PM','7:00PM','AB124');
...
------TABLE FOR SEAT
--create table  SEAT(Flight_Number varchar(255), Leg_No number,Date_Leg date,foreign key(Flight_Number,Leg_no,Date_Leg) references Leg_Instance(Flight_Number,Leg_No,Date_Leg),Seat_Number number,PRIMARY KEY(Flight_Number,Leg_No,Date_Leg,Seat_Number),Customer_name varchar(255),Customer_Phone varchar(255));
--INSERT INTO SEAT VALUES('LN3211',1,'01-01-2014',1,'VISHNU','9989808705');
--INSERT INTO SEAT VALUES('GT4638',2,'01-01-2014',2,'VISHNU','9989808705');
...
--inner join AIRPORT on FLIGHT_LEG.Depature_Airport_Code = AIRPORT.airport_code
--where airport.city='KURNOOL';

--VII
--vii.	Find how many passengers are travelled from city X on 01-01-2014
--SELECT COUNT(seat.customer_name)AS NOOFCUSTOMERS,SEAT.DATE_LEG
--FROM ((LEG_INSTANCE 
--INNER JOIN AIRPORT ON AIRPORT.AIRPORT_CODE=LEG_INSTANCE.Depature_Airport_Code)
--INNER JOIN SEAT ON SEAT.DATE_LEG=LEG_INSTANCE.DATE_LEG AND SEAT.LEG_NO=LEG_INSTANCE.LEG_NO AND SEAT.FLIGHT_NUMBER=LEG_INSTANCE.FLIGHT_NUMBER)
--WHERE LEG_INSTANCE.DATE_LEG='01-01-2014' AND airport.city='HYDERABAD'
--GROUP BY SEAT.DATE_LEG  ;

--V
--v.	Find all flights departure from City X.
...
--i)
--SELECT COUNT(SEAT_NUMBER) AS NOOFSEATSBOOKED,CUSTOMER_NAME
--FROM SEAT
